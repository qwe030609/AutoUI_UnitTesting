...
namespace PP5AutoUITests
{
    ...
    public partial class OrderedDictionary<TKey, TValue>
    {
        ...
        public void Insert(int index, TKey key, TValue value)
        {
            ...
            _innerDictionary.Add(key, value); // Add to dictionary for fast key lookup
            _innerList.Insert(index, new KeyValuePair<TKey, TValue>(key, value)); // Maintain order in the list
        }
        ...
        {
            get { return (TValue)_innerDictionary[key]; }
            set { _innerDictionary[key] = value; }
        }
        public int Count => _innerList.Count;
        //public int CountWhen<TSource>(Func<TSource, bool> predicate)
        //{
        //    return _innerDictionary.AsEnumerable().Count(predicate);
        //}
        public Dictionary<TKey, TValue> AsDictionary() => _innerDictionary;
